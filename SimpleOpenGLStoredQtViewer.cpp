...
SimpleOpenGLStoredQtViewer::SimpleOpenGLStoredQtViewer
...
void SimpleOpenGLStoredQtViewer::Initialise() {
  makeCurrent();
...
void SimpleOpenGLStoredQtViewer::initializeGL () {
...
G4bool SimpleOpenGLStoredQtViewer::CompareForKernelVisit(G4ViewParameters& lastVP)
{
  // Identical to G4OpenGLStoredViewer::CompareForKernelVisit except
  // for checking of VisAttributesModifiers, because
  // SimpleOpenGLStoredQtViewer keeps track of its own touchable
...
G4bool SimpleOpenGLStoredQtViewer::POSelected(size_t POListIndex)
{
  return isTouchableVisible(POListIndex);
}

G4bool SimpleOpenGLStoredQtViewer::TOSelected(size_t)
{
  return true;
}

void SimpleOpenGLStoredQtViewer::DrawView () {
  updateQWidget();
}

void SimpleOpenGLStoredQtViewer::ComputeView () {
...
*/
void SimpleOpenGLStoredQtViewer::resizeGL(
                                      int aWidth
                                      ,int aHeight)
{
...
void SimpleOpenGLStoredQtViewer::paintGL()
{
...
void SimpleOpenGLStoredQtViewer::paintEvent(QPaintEvent *) {
  if (! fQGLWidgetInitialiseCompleted) {
    return;
  }
...
void SimpleOpenGLStoredQtViewer::mousePressEvent(QMouseEvent *event)
{
  G4MousePressEvent(event);
}

void SimpleOpenGLStoredQtViewer::keyPressEvent (QKeyEvent * event)
{
  G4keyPressEvent(event);
}

void SimpleOpenGLStoredQtViewer::keyReleaseEvent (QKeyEvent * event)
{
  G4keyReleaseEvent(event);
}

void SimpleOpenGLStoredQtViewer::wheelEvent (QWheelEvent * event)
{
  G4wheelEvent(event);
}

void SimpleOpenGLStoredQtViewer::showEvent (QShowEvent *)
{
  if (fQGLWidgetInitialiseCompleted) {
    fHasToRepaint = true;
  }
 ...
 */
void SimpleOpenGLStoredQtViewer::mouseDoubleClickEvent(QMouseEvent *)
{
  G4MouseDoubleClickEvent();
}

void SimpleOpenGLStoredQtViewer::mouseReleaseEvent(QMouseEvent *event)
{
  G4MouseReleaseEvent(event);
}

void SimpleOpenGLStoredQtViewer::mouseMoveEvent(QMouseEvent *event)
{
  G4MouseMoveEvent(event);
}


void SimpleOpenGLStoredQtViewer::contextMenuEvent(QContextMenuEvent *e)
{
  G4manageContextMenuEvent(e);
}

void SimpleOpenGLStoredQtViewer::updateQWidget() {
  if (fUpdateGLLock) {
    return;
  }
...
void SimpleOpenGLStoredQtViewer::ShowView (
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
void SimpleOpenGLStoredQtViewer::DisplayTimePOColourModification (
G4Colour& c,
size_t poIndex) {
